            ...
            <div className="flex flex-col flex-grow">
              <div className="flex flex-col">
                <div className="flex-grow flex flex-col justify-end">
                  ...
                  <div className="text-sm text-gray-600">Unlock continuous self assessment by completing more than 60 questions. The more questions you answer, the more accurate the assessment is.</div>
                </div>
              </div>
            </div>
