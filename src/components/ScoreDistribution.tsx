  ...
  return (
    <g style={{ zIndex: 1000 }}>
      <line 
        ...
        strokeDasharray="3 3"
      />
      <foreignObject x={x - 70} y={0} width={140} height={60}>
        <div className="bg-white/90 border border-emerald-200 rounded-md px-3 py-2 shadow-sm flex items-center gap-2">
