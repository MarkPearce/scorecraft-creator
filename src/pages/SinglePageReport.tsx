    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 pt-24 pb-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="flex items-center justify-between">
            ...
            >
              <div className="flex items-center space-x-2 hover:bg-gray-200 rounded-lg px-3 py-2 transition-colors cursor-pointer">
                ...
                <Label htmlFor="step1" className="text-sm font-medium cursor-pointer font-lato">
                  USMLE Step 1
                </Label>
              </div>
              <div className="flex items-center space-x-2 hover:bg-gray-200 rounded-lg px-3 py-2 transition-colors cursor-pointer">
                <RadioGroupItem value="step2" id="step2" />
                <Label htmlFor="step2" className="text-sm font-medium cursor-pointer font-lato">
                  USMLE Step 2
                </Label>
              </div>
            </RadioGroup>
          ...
          <div>
            <h1 className="text-3xl font-[900] text-gray-900 font-lato">
              Continuous performance assessment
            </h1>
            <p className="mt-2 text-gray-600 font-lato">
              Here is your assessment based on AMBOSS Qbank performance.
            </p>
          </div>
